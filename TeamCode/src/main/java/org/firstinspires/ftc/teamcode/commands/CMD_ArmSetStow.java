...
public class CMD_ArmSetStow extends SequentialCommandGroup {
     public CMD_ArmSetStow(SUB_Shoulder p_shoulder, SUB_Elbow p_elbow, SUB_Wrist p_wrist, GlobalVariables p_variables){
          p_variables.setRobotState(GlobalVariables.RobotState.Stow);
          addCommands(
