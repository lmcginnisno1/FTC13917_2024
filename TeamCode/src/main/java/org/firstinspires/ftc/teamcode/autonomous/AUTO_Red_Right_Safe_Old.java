...
@Disabled
@Autonomous(name = "Auto Red Right Safe Old", group = "Auto Red Right", preselectTeleOp = "Robot Teleop")
public class AUTO_Red_Right_Safe_Old extends Robot_Auto {
     int m_Analysis;
     public AUTO_Red_Right_Safe_Old() {
          super(true);
     }
