          ...
          switch (m_Analysis){
               ...
               case 2:
                    cmds.addCommands(
                            ...
                            ,new ParallelCommandGroup(
                                    new CMD_SetElbowAngle(m_robot.m_elbow, -165)
                                    ,new CMD_SetShoulderAngle(m_robot.m_shoulder, 175)
                                    ,new CMD_SetWristPosition(m_robot.m_wrist, .75)
                            )
                            ,new Sleep(500)
                            ,new CMD_WristReleaseOutsideClaw(m_robot.m_wrist)
