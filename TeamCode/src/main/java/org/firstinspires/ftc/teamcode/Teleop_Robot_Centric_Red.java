...
//                telemetry.addData("pincher open", m_robot.m_wrist.getIsPincherOpen());
     ...
     public void configureButtonBindings() {
          ...
          AddButtonCommand(m_driverOp, GamepadKeys.Button.LEFT_BUMPER,
                  new CMD_HandleReadyToDeploy(m_robot,getRedSide())
               );
          ...
          AddButtonCommandNoInt(m_driverOp, GamepadKeys.Button.START, new ConditionalCommand(
              new SequentialCommandGroup(
                      new CMD_SetReadyToIntake(m_robot.m_shoulder, m_robot.m_elbow, m_robot.m_wrist,
