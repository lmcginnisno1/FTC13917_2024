...
@Disabled
@Autonomous(name = "Auto Red Right Gate Old", group = "Auto Red Right", preselectTeleOp = "Robot Teleop")
public class AUTO_Red_Right_Gate_Old extends Robot_Auto {
     int m_Analysis;
     public AUTO_Red_Right_Gate_Old() {
          super(true);
     }
