...
@Autonomous(name = "Auto Blue Left Truss", group = "Auto Blue Left", preselectTeleOp = "Robot Teleop")
public class AUTO_Blue_Left_Truss extends Robot_Auto {
     int m_Analysis;
     public AUTO_Blue_Left_Truss() {
          super(false);
     }
