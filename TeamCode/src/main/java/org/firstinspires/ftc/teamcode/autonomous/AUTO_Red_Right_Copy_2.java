...
@Autonomous(name = "Red Right new copy 2", group = "Auto Red", preselectTeleOp = "Robot Teleop")
public class AUTO_Red_Right_Copy_2 extends Robot_Auto {
     int m_Analysis;
     public AUTO_Red_Right_Copy_2() {
          super(true);
     }
