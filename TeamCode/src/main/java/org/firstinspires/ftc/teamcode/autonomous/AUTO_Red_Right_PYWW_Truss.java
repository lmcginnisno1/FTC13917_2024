...
@Autonomous(name = "Auto Red Right PYWW Truss", group = "Auto Red", preselectTeleOp = "Robot Teleop")
public class AUTO_Red_Right_PYWW_Truss extends Robot_Auto {
     int m_Analysis;
     public AUTO_Red_Right_PYWW_Truss() {
          super(true);
     }
