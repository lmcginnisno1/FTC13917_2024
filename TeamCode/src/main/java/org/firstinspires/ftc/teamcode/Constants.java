...
//          public static final double kPPR = 2786.2;// Calculated using a 99.5:1 ratio motor
          ...
          public static final double[] kReadyToDeployPosition = {0.0, 120.0, 105.0, 100, 97.5, 100, 102.5, 102.5, 120};//0, 120.0, 110, 97.5, 97.5
     ...
     public static final class WristConstants{
          ...
          public static final double kClawAClose = 0.65;
          ...
          public static final double[] kReadyToDeployPosition = {0.0, 0.0, 0.11, 0.2, 0.25, 0.3, 0.3, 0.4, 0.5};//0, .25, .35, .45, .5
