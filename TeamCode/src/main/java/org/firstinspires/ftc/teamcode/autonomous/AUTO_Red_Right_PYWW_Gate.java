...
@Autonomous(name = "Auto Red Right PYWW Gate", group = "Auto Red", preselectTeleOp = "Robot Teleop")
public class AUTO_Red_Right_PYWW_Gate extends Robot_Auto {
     int m_Analysis;
     public AUTO_Red_Right_PYWW_Gate() {
          super(true);
     }
