...
@Autonomous(name = "Blue Left new copy 1", group = "Auto Blue", preselectTeleOp = "Robot Teleop")
public class AUTO_Blue_Left_Copy_1 extends Robot_Auto {
     int m_Analysis;
     public AUTO_Blue_Left_Copy_1() {
          super(false);
     }
