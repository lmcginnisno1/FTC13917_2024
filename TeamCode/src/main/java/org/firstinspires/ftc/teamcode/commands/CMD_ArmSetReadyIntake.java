...
public class CMD_ArmSetReadyIntake extends ParallelCommandGroup {
    public CMD_ArmSetReadyIntake(SUB_Shoulder p_shoulder, SUB_Elbow p_elbow, SUB_Wrist p_wrist, GlobalVariables p_variables){
        p_variables.setRobotState(GlobalVariables.RobotState.ReadyToIntake);
        addCommands(
