...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(40, 0, 9.5,
            12);
    ...
    public static double GEAR_RATIO = 1.0104; // output (wheel) speed / input (motor) speed
