...
public abstract class TrapezoidProfileSubsystem extends SubsystemBase {
  ...
  private void requireNonNullParam(TrapezoidProfile.Constraints constraints, String constraints1, String trapezoidProfileSubsystem) {
    /* TODO: make this put a real error message somewhere. Like print it to the Driver Station. */
  }
