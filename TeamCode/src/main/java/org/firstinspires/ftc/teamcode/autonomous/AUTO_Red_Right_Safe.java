...
import org.firstinspires.ftc.teamcode.commands.CMD_AutoAlign;
...
import org.firstinspires.ftc.teamcode.commands.RR_TrajectoryBuildFromCurrent;
...
public class AUTO_Red_Right_Safe extends Robot_Auto {
     ...
     private SequentialCommandGroup placePurplePixel(){
          ...
          Trajectory m_dropSpot1 = m_robot.drivetrain.trajectoryBuilder(m_purplePixel1.end(), true)
                  .splineTo(new Vector2d(40, -29.5), Math.toRadians(0))
                  .build();
          ...
          Trajectory m_dropSpot3 = m_robot.drivetrain.trajectoryBuilder(m_purplePixel3.end(), true)
                  .splineTo(new Vector2d(43, -40.0), Math.toRadians(0))
                  .build();
          ...
          switch (m_Analysis){
               case 1:
                    cmds.addCommands(
                            ...
                            ,new RR_TrajectoryBuildFromCurrent(m_robot, new Vector2d(50, -30), Math.toRadians(0), true)
                            ,new Sleep(100)
               ...
               case 2:
                    cmds.addCommands(
                            ...
                            ,new VisionUpdatePose(m_robot.m_backCamera, m_robot.drivetrain)
                            ,new RR_TrajectoryBuildFromCurrent(m_robot, new Vector2d(50, -36), Math.toRadians(0), true)
                            ,new Sleep(100)
                            ,new CMD_WristReleaseOutsideClaw(m_robot.m_wrist)
                            ,new Sleep(100)
                            ,new CMD_WristReleaseClaw(m_robot.m_wrist)
               ...
               case 3:
                    cmds.addCommands(
                            ...
                            ,new VisionUpdatePose(m_robot.m_backCamera, m_robot.drivetrain)
                            ,new RR_TrajectoryBuildFromCurrent(m_robot, new Vector2d(50, -44), Math.toRadians(0), true)
                            ,new Sleep(100)
                            ,new CMD_WristReleaseOutsideClaw(m_robot.m_wrist)
                            ,new Sleep(100)
                            ,new CMD_WristReleaseClaw(m_robot.m_wrist)
