...
@Autonomous(name="Auto Red Left Safe", group = "Auto Red Left", preselectTeleOp = "Robot Teleop")
public class AUTO_Red_Left_Safe extends Robot_Auto {

     private int m_Analysis;

     public AUTO_Red_Left_Safe(){
        super(true);
     }
